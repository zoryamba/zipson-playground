    ...
    view! {
        <main class="max-w-screen-xl px-4 m-auto">
            ...
            <section class="pt-10 pb-4">
                ...
                <p class="pb-2">
                    <a href="https://www.npmjs.com/package/zipson" class="text-blue-600 dark:text-blue-500 hover:underline" target="_blank">"Zipson"</a>
                    " is a drop-in alternative to JSON.parse/stringify with added compression and streaming support written in JavaScript."
                </p>
                <p class="pb-2">
                    <a href="https://github.com/zoryamba/serde_zipson" class="text-blue-600 dark:text-blue-500 hover:underline" target="_blank">"serde_zipson"</a>
                    " is "<a href="https://serde.rs/" class="text-blue-600 dark:text-blue-500 hover:underline" target="_blank">"serde"</a>"-compatible Rust implementation of zipson compression format."
                </p>
            </section>
            <section class="pt-10 pb-4">
