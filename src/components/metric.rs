...
pub fn Metric(name: &'static str, units: &'static str, tooltip_text: &'static str, value: impl Fn() -> f32 + 'static) -> impl IntoView {
    view! {
        <div class="pr-5">
            ...
            <div id="grid" class=" ">
              <div id="gridItem" class="relative h-3 w-3 cursor-pointer items-center shadow-md hover:z-50" data-tooltip="LOOK HERE">
                <svg class="w-6 h-6 text-blue-300 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
